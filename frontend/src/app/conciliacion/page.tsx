    ...
    return (
        <div className="flex flex-col h-full gap-4 overflow-hidden">
            ...
            <div className="flex gap-4 shrink-0">
                <div className="flex-1 bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col justify-center">
                ...
                >
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-sm font-medium text-gray-600">Arrastra tu fichero Norma 43 (.txt)</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex gap-4 flex-1 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col bg-gray-50 border rounded-xl overflow-hidden shadow-inner">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-3">
                        ...
                        {movimientosBanco.map((b, idx) => (
                            <div key={idx} className={`p-4 rounded-lg border shadow-sm flex flex-col gap-1 transition-colors ${b.matchedWith ? 'bg-green-50 border-green-400' : 'bg-white border-gray-200'}`}>
                                <div className="flex justify-between items-start">
                                    <span className="font-bold text-gray-800">{b.Fecha}</span>
                                ...
                                <span className="text-sm text-gray-600 truncate" title={b.Concepto}>{b.Concepto}</span>
                ...
                <div className="flex-1 flex flex-col bg-gray-50 border rounded-xl overflow-hidden shadow-inner">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-3">
                        ...
                        {movimientosMayor.map((m, idx) => {
                            ...
                            return (
                                <div key={idx} className={`p-4 rounded-lg border shadow-sm flex flex-col gap-1 transition-colors ${m.matchedWith ? 'bg-green-50 border-green-400' : 'bg-white border-gray-200'}`}>
                                    <div className="flex justify-between items-start">
                                        <span className="font-bold text-gray-800">{m.Fecha} <span className="text-xs text-gray-400 ml-1">Asiento {m.IdAsiento}</span></span>
                                    ...
                                    <span className="text-sm text-gray-600 truncate" title={m.Concepto}>{m.Concepto}</span>
